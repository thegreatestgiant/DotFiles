...
if ((resolution >= 2160)); then
    ...
    wlogout --protocol layer-shell -b 6 -T $T_val -B $B_val -l "${CONFIG}/layout" --css "${CONFIG}/style.css" &
    ...
    wlogout --protocol layer-shell -b 3 -T $T_val -B $B_val -l "${CONFIG}/layout" --css "${CONFIG}/style.css" &
else
