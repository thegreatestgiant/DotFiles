...
local rofiPath = HOME .. "/.config/hypr/rofi/config.rasi"

-- ----------------------------------------------------- 
-- 🚀 APPLICATIONS & LAUNCHERS
-- ----------------------------------------------------- 
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("pkill rofi || true && rofi -show drun -modi drun,filebrowser,run,window -config ~/.config/hypr/rofi/config.rasi"), { description = "app launcher" })
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("env ELECTRON_OZONE_PLATFORM_HINT=wayland xdg-open \"https://\""), { description = "open default browser" })
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("obsidian"), { description = "Obsidian" })
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("brave-browser --app-id=hnpfjngllnobngcgfapefoaidbinmjnm"), { description = "WhatsApp" })
hl.bind("F12", hl.dsp.exec_cmd("rog-control-center"), { description = "Open the G-Helper Equiv" })

-- ----------------------------------------------------- 
-- 📋 FEATURES / EXTRAS
-- ----------------------------------------------------- 
hl.bind(mainMod .. " + SHIFT + SLASH", hl.dsp.exec_cmd(scriptsDir .. "/KeyHints.sh"), { description = "help / cheat sheet" })
...
hl.bind(mainMod .. " + O", hl.dsp.window.set_prop({ prop = "opaque", value = "toggle", window = "active" }), { description = "toggle active window opacity" })
hl.bind(mainMod .. " + grave", hl.dsp.exec_cmd(scriptsDir .. "/Dropterminal.sh $term"), { description = "DropDown terminal" })
